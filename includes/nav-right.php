	...
	<div class="fl-page-header-wrap">
		<div class="fl-page-header-container container">
			<div class="fl-page-header-row row">
				<div class="col-md-7 col-sm-12 fl-page-header-logo-col">
					<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/robbymccullough.png" alt="Robby McCullough" class="fl-headshot">
					<div class="fl-page-header-logo" itemscope="itemscope" itemtype="http://schema.org/Organization">
						<a href="<?php echo home_url(); ?>" itemprop="url"><?php FLTheme::logo(); ?></a>
						<div class="fl-subheader-text"><?php echo bloginfo('description'); ?> </div>
					</div>
				</div>
				<div class="fl-page-nav-col col-md-5 col-sm-12">
